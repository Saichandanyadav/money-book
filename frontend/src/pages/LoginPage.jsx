    ...
    <div className="min-h-screen w-full flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-[40%] flex items-center justify-center bg-white px-6 py-0 h-screen lg:h-auto">
        <div className="w-full max-w-md flex flex-col gap-4">
          ...
          <input type="email" placeholder="Email for Testing: test@example.com" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="border p-3 rounded-lg" />
          <PasswordInput placeholder="Password: Test@1010" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} className="border p-3 rounded-lg" />
